...
class TestApp(unittest.TestCase):
    ...
    def test_should_return_polynom_coefficients_when_second_grade(self):
        ...
        self.assertEqual(expected, self.util.generate_polynom_coefficients(
    ...
    def test_should_return_multiplied_polynom(self):
        ...
        self.assertEqual(expected, self.util.multiply_polynoms(pol1, pol2))
    ...
    def test_should_return_polynom_with_multiplied_elements(self):
        ...
        expected = [4, 20, 8]
        self.assertEqual(
            expected, self.util.multiply_each_element_of_polynom(pol1, factor))

    def test_should_return_added_polynoms(self):
        pol1 = [1, 5, 2]
        pol2 = [6, 1, 18]
        expected = [7, 6, 20]
        self.assertEqual(expected, self.util.add_polynoms(pol1, pol2))

    def test_should_return_added_polynoms_when_one_empty(self):
        pol1 = []
        pol2 = [6, 1, 18]
        self.assertEqual(pol2, self.util.add_polynoms(pol1, pol2))
    ...
    def test_should_return_standard_polynom(self):
        ...
        self.assertEqual(
            expected, self.util.transform_coefficients_to_pretty_polynom(coeffiecients))
