...
# alle_li_function aumultiplizieren --> newton multiply_poly (self, alle_li_funktion)
    #def multiply_li_function(self, n, alle_li_function, alle_li_x_werte):
        #li_ausmult = []
        # np = self.np
        # li_ausmult = np.array([])
        ...
        #     dritter_summand = 1
        #     for j in range(n -1):
        #         zweiter_summand = zweiter_summand + alle_li_function[i][j]
        #         dritter_summand = dritter_summand * alle_li_function[i][j]
                
        #     li_ausmult = np.append(li_ausmult,[erster_summand, zweiter_summand, dritter_summand])
            
        # print("li_ausmult",li_ausmult)
        #return li_ausmult
